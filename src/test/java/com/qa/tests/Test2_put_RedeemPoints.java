...
public class Test2_put_RedeemPoints extends TestBase {
	...
	@Test
	public void redeemPoints() throws JsonGenerationException, JsonMappingException, IOException{
		...
		Users u = new Users("kasasa","1234","100","20100");
